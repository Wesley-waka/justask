    ...
    <nav
        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto py-2.5 lg:py-0">
            ...
            <a href="#" class="flex items-center">
                <img src="~/assets/images/just-ask.svg" alt="Logo" class="h-8 lg:h-20">
                ...
                <ul
                    ...
                    <li v-for="(link, index) in navLinks" :key="index"
                        ...
                        <NuxtLink v-if="!link.subMenu" :to="link.path" @click="closeMenu"
                            :class="['block py-2 pl-3 pr-4 rounded lg:p-0 whitespace-nowrap', scrolled ? 'lg:text-gray-800 text-white' : ' text-white']">
                            {{ link.name }}
                        </NuxtLink>
                        <div v-else>
